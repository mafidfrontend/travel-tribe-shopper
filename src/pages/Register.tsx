...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "ShopList'ga xush kelibsiz!",
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">ShopList</h1>
          <p className="text-gray-600">Sayohat guruhlari uchun hamkorlikda xarid qilish</p>
        </div>
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center text-gray-600">
              Boshlash uchun ma'lumotlaringizni to'ldiring
            </CardDescription>
          </CardHeader>
          <CardContent>
